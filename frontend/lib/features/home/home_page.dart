...
class HomePageState extends State<HomePage> {
  ...
  ///
  /// (The command CHAT now lives entirely in the full-screen [CommandChatPage],
  /// driven by a CommandChatController the shell owns — Home just shows today's
  /// bubbles. It listens to the store, so tasks added/edited from chat still show
  /// up here on the next rebuild.)
  int _replay = 0;
